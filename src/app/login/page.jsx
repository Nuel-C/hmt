        ...
        <main className="p-5 fixed z-10 h-full w-full block backgroundImage1" id="nv2" ref={ref}>
            <div id='nv3' className="mt-2 mx-2 lg:mx-96 md:mx-44 mt-44">
                <div className="h-full flex flex-col justify-center items-center my-5">
                    <h1 className="mb-7 text-2xl font-bold">Login</h1>
                    ...
                    <span className="mt-4 text-sm">Do not have an account? Sign Up <Link href="/signup" className="text-blue-500">Here</Link></span>
                </div>
            </div>
        </main>
    );
