    ...
    <main>
      ...
      <div className='backgroundImage1 w-full h-screen p-5 flex flex-col justify-between' ref={ref}>
        ...
        <div className="flex justify-center">
          <text className={`${pacifico.className} bg-black text-white p-2 rounded`}>Explore collection <i className="fa fa-angle-double-down" aria-hidden="true"></i></text>
        </div>
      </div>
      ...
      <div className="backgroundImage4 w-full h-screen p-5 flex flex-col justify-between">
        <div></div>
        <div className="grid">
          <text className={`${grey_qo.className} bg-black text-white p-2 rounded justify-self-end`}>The new collection is <br/>the synthesis of the harmonious <br/>elements of Playful elegance <br/><br/>EXPLORE OUR NEW COLLECTION <i className="fa fa-angle-double-down" aria-hidden="true"></i></text>
        </div>
      </div>
